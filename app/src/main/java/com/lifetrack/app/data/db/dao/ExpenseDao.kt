...
interface ExpenseDao {
    ...
    @Query("UPDATE transactions SET categoryId = :catId, manualOverride = 1 WHERE id = :txnId")
    ...
    @Query("UPDATE transactions SET categoryId = :catId WHERE matchKey = :key AND manualOverride = 0")
